<template>
  ...
  >
    ...
    <div
      ...
      class="relative py-20 mx-auto text-center max-w-7xl"
    >
      <h3 class="mb-4 text-2xl font-semibold text-stone-600">
    ...
    <div v-else class="relative mx-auto max-w-7xl">
      ...
      >
        <div
          class="absolute w-32 h-32 rounded-full top-10 left-10 bg-rose-200 blur-3xl"
        ></div>
        <div
    ...
    <div class="relative mx-auto max-w-7xl">
      <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
        ...
        >
          ...
          <div
            class="relative rounded-3xl overflow-hidden min-h-[500px] bg-gradient-to-br from-stone-50 to-stone-100 group-hover:shadow-2xl transition-all duration-700"
          >
            ...
            <div class="relative w-full h-full min-h-[500px] overflow-hidden">
              <img
                ...
                class="absolute inset-0 w-full h-full mx-auto transition-all duration-700 ease-out group-hover:scale-110"
                loading="lazy"
              />

              <!-- Overlay gradient for better text readability -->
              <div
                class="absolute inset-0 transition-opacity duration-500 opacity-0 bg-gradient-to-t from-black/20 via-transparent to-transparent group-hover:opacity-100"
              ></div>
            </div>
            ...
            >
              <div
                class="px-4 py-2 text-sm font-semibold capitalize border rounded-full shadow-lg bg-white/95 backdrop-blur-sm text-stone-800 border-white/20"
              >
              ...
              <div
                ...
                class="px-3 py-1 text-xs font-bold text-white bg-red-500 rounded-full shadow-lg animate-pulse"
              >
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-1">
                  <svg
                    class="w-4 h-4 fill-current text-amber-400"
                    viewBox="0 0 20 20"
                  >
                    <path
                  ...
                  <span class="font-semibold">{{
                    (currentProduct?.ratings?.average || 0).toFixed(1)
                  }}</span>
                </div>
            ...
            <div
              class="absolute inset-0 z-10 flex items-center justify-center transition-all duration-500 opacity-0 group-hover:opacity-100"
            >
              <button
          ...
          <div class="space-y-6">
            ...
            >
              {{
                ...
                "Experience the transformative power of our premium collection, meticulously crafted to enhance your natural beauty."
              }}
            </p>
            ...
            >
              ...
              <span
                v-if="currentProduct.salePrice && currentProduct.originalPrice"
          ...
          >
            ...
            >
              <div class="text-lg font-semibold text-stone-900">
                {{ currentProduct.featuredMetrics.views || 0 }}
              </div>
            ...
            >
              <div class="text-lg font-semibold text-stone-900">
                {{ currentProduct.featuredMetrics.clicks || 0 }}
              </div>
            ...
            >
              <div class="text-lg font-semibold text-stone-900">
                {{ currentProduct.featuredMetrics.ctr || 0 }}%
              </div>
            ...
            <div class="flex flex-col gap-4 sm:flex-row">
              ...
              >
                <span class="flex items-center justify-center gap-2">
                  ...
                  <svg
                    class="w-4 h-4 transition-transform duration-200 transform group-hover:translate-x-1"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
              ...
              >
                <span class="flex items-center justify-center gap-2">
                  ...
                  <div
                    class="flex items-center justify-center w-6 h-6 transition-transform duration-300 border-2 border-current rounded-full group-hover:rotate-90"
                  >
                    <svg
                      class="w-3 h-3"
                      fill="none"
