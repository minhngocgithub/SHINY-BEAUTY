        ...
        <div class="relative flex items-center justify-between h-16">
          ...
          >
            ...
            <div v-else class="relative ml-3 group">
              ...
              <div
                class="absolute right-0 z-10 hidden w-48 py-1 mt-2 origin-top-right bg-white rounded-md shadow-lg group-hover:block ring-1 ring-black ring-opacity-5 focus:outline-none"
                role="menu"
