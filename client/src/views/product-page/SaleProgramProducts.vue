                ...
                <div class="space-y-2 text-sm">
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <span class="font-bold"
                      >{{ totalProducts }} Products Available</span
                    >
                  </div>
                </div>
                <button
            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
              ...
              <div class="flex items-center gap-2 text-sm">
                ...
                <span class="font-semibold text-gray-800"
                  ...
                  <span
                    v-if="filteredProductsCount !== totalProducts"
                    class="text-gray-500"
                  >
                    ({{ totalProducts }} total in program)
                  </span>
                </span>
              </div>
  ...
  try {
    ...
    const [programRes, productsRes] = await Promise.all([
      ...
      getProductsBySaleProgramApi(saleProgramId, {
        ...
        limit: 1000, // Get all products first
    ...
    if (productsRes?.data?.success) {
      ...
      console.log("✅ Products loaded:", {
        ...
        hasImage: !!allProducts.value[0]?.image,
      });
    } else {
      allProducts.value = [];
