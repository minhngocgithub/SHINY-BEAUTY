<template>
  <div class="w-full min-h-screen bg-gradient-to-b from-rose-50 to-white">
    <section class="relative">
      <Header />

      <div class="pb-8 " data-aos="fade-down" data-aos-duration="1000">
        <SaleProgram />
      </div>
      <section
        class="pb-12"
...
const addStructuredData = () => {
  const structuredData = {
    ...
    description:
      "Discover premium cosmetic collections with innovative formulations and luxurious textures. Shop featured products, flash sales, and new arrivals.",
