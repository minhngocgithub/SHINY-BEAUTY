  ...
  <div class="flex flex-col min-h-screen">
    ...
    <div :class="{'blur': isLoading}" class="flex items-center justify-around mt-4 mb-40 content-wrapper grow">
      <div class="container">
        ...
        <div v-if="message" class="p-3 mt-4 text-center rounded alert" :class="isSuccess ? 'alert-success bg-green-100 text-green-700' : 'alert-danger bg-red-100 text-red-700'">
          {{ message }}
        </div>
      </div>
    </div>
