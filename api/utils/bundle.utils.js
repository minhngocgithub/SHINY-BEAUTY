...
class BundleUtils {
    ...
    static formatBundleForCart(bundle) {
        ...
        // Return full bundle data without transformation to preserve populated fields
        return {
            ...bundle.toObject ? bundle.toObject() : bundle,
            // Add computed fields
            savings: bundle.savings || (bundle.originalPrice - bundle.bundlePrice),
            actualDiscountPercentage: bundle.actualDiscountPercentage || bundle.discountPercentage
        };
    }
