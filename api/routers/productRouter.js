...
router.get('/trending', applySaleProgramToProducts, productController.getTrendingProducts)
...
// CATEGORY ROUTES (support multi-level paths like makeup/face-makeup/foundation)
router.get('/by-category/*', applySaleProgramToProducts, productController.getProductsByCategory)
router.get('/filters/*', productController.getCategoryFilters)
...
router.post('/upload-images', authenticate, authorizeAdmin, upload.array('images', 5), productController.uploadProductImages)
router.post('/:id/upload-images', authenticate, authorizeAdmin, upload.array('images', 3), productController.uploadMultipleProductImages)
router.put('/:id/main-image', authenticate, authorizeAdmin, productController.setMainProductImage)
router.delete('/:id/images/:imageId', authenticate, authorizeAdmin, productController.deleteProductImage)
